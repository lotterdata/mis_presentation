...
model1 <- glm(winners_3~I(n1+n2+n3+n4+n5),data=tx.train,
              family=poisson,
              offset=log(sales))
knitr::kable(summary(model1)$coefficients,digits=4)
```
...
model2 <- glm(winners_3~n1+n2+n3+n4+n5,data=tx.train,
              family=poisson,
              offset=log(sales))
knitr::kable(summary(model2)$coefficients,digits=4)
```
